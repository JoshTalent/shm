...
const Header = ({ isMobileMenuOpen, setIsMobileMenuOpen, activeTab }) => {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-start">
            <button
              ...
              className="group p-2 rounded-lg lg:hidden transition-all duration-300 text-gray-600 hover:bg-gray-100 hover:text-gray-900"
            >
          ...
          <div className="flex items-center gap-2 md:gap-4">
            {/* Notifications */}
            <button
              className="relative p-2 rounded-lg transition-all duration-300 group text-gray-600 hover:bg-gray-100 hover:text-gray-900"
            >
            ...
            <div className="relative">
              <button 
                ...
                className="flex items-center gap-2 p-1.5 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 text-gray-700 hover:bg-gray-100 focus:ring-gray-300"
              >
              ...
              {isProfileMenuOpen && (
                <div 
                  className="absolute right-0 mt-2 w-56 rounded-lg shadow-lg py-1 transition-all duration-300 transform origin-top-right bg-white border border-gray-200 shadow-gray-200/50 animate-dropdown"
                >
                  <div className="px-4 py-2 border-b border-gray-200">
                    <p className="text-sm font-medium text-gray-900">Dr. Richard</p>
                    <p className="text-xs text-gray-500">richard@healthcare.com</p>
                  </div>

                  <Link
                    to="/profile"
                    className="flex items-center gap-2 px-4 py-2 text-sm transition-colors duration-300 group text-gray-700 hover:bg-gray-100"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 w-full px-4 py-2 text-sm transition-colors duration-300 group text-red-600 hover:bg-gray-100"
                  >
