...
const Sidebar = ({ isMobileMenuOpen, activeTab, setActiveTab }) => {
  return (
    <>
      <aside className={`fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform duration-500 ease-in-out transform bg-white border-gray-200 shadow-lg shadow-gray-200/20 border-r ${
        isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'
      } lg:translate-x-0`}>
        <div className="h-full px-3 pb-4 overflow-y-auto transition-colors duration-300 bg-white">
          {/* Primary Navigation */}
          ...
          <div className="mt-6 mb-4 px-3 text-gray-500">
          ...
          {/* Pro Badge */}
          <div className="mt-6 p-4 rounded-lg transition-all duration-300 bg-gradient-to-br from-gray-50 to-gray-100">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-semibold text-gray-900">Pro Member</p>
